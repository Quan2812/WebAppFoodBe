...
namespace FOLYFOOD.Migrations
{
    ...
    [Migration("20250416082335_AddCloumnCodeTableOrderStatus")]
    partial class AddCloumnCodeTableOrderStatus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FOLYFOOD.Entitys.Order", b =>
                {
                    ...
                    b.Property<string>("ImageComplete")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<int>("PaymentOrderPaymentId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PaymentOrderPaymentId");
            ...
            modelBuilder.Entity("FOLYFOOD.Entitys.PaymentOrder", b =>
                {
                    b.Property<int>("PaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FOLYFOOD.Entitys.Voucher", b =>
                {
            ...
            modelBuilder.Entity("FOLYFOOD.Entitys.VoucherUser", b =>
                {
            ...
            modelBuilder.Entity("FOLYFOOD.Entitys.Order", b =>
                {
                    ...
                    b.HasOne("FOLYFOOD.Entitys.PaymentOrder", "PaymentOrder")
                        .WithMany("Order")
                        .HasForeignKey("PaymentOrderPaymentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("FOLYFOOD.Entitys.VoucherUser", b =>
                {
                    ...
                    b.HasOne("FOLYFOOD.Entitys.Voucher", "Voucher")
                        .WithMany("VoucherUsers")
